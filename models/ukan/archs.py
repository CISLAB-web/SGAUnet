...
class UKANBackbone(nn.Module):
    """
    Encoder + tokenized KAN bottleneck from U-KAN (no decoder).
    Output shape [B, embed_dims[2], H, W]. Matches SKIN_Q resize 256 when img_size=256.
    """
